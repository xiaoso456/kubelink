...
public class KubeConfig implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        // TypeReference<List<SyncConfig>> listTypeReference = new TypeReference<>() {};
        // List<SyncConfig> syncConfigList = objectMapper.readValue(syncConfig, listTypeReference);
        // for (SyncConfig syncInfo : syncConfigList) {
